...
const ProductSpecs = ({ reviews, details }: ProductSpecsProps) => {
          ...
          <div className="p-4  overflow-y-auto max-h-[500px]">
            {reviews.length > 0 ? (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <div className=" flex  text-[10px] items-center text-green-200  ">
                            <BadgeCheck className="w-4 text-blue-700" />
                            Verified Customer
                          </div>
                        </div>
                      </div>
              ...
              <div className="h-[400px]  flex flex-col items-center justify-center p-5 ">
                ...
                <h3 className="text-md text-center font-medium text-muted-foreground ">
