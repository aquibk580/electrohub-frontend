  ...
  return (
    <div className=" space-y-5 ">
      <div className="border rounded-xl p-4 space-y-4 animate__animated animate__fadeIn shadow-sm bg-[#e8e8e814]">
        <h2 className="text-2xl text-gray-800 font-semibold">Products</h2>

        <div className="w-full lg:w-[100%] flex flex-nowrap bg-zinc-100 rounded-lg overflow-x-auto whitespace-nowrap scrollbar-x">
          ...
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="p-3 px-4 border-l-2 border-zinc-300 min-w-[200px]  flex flex-col"
            >
      ...
      <div className="space-y-3 border p-3 rounded-xl shadow-sm  bg-[#e8e8e814] animate__animated animate__fadeIn">
        <h2 className="text-xl pl-1 text-gray-800 font-semibold">
          All Product Lists
        </h2>
        <div className="flex flex-nowrap  gap-2 items-center justify-between">
          <div className="relative   w-full sm:w-72">
            ...
            <Input
              ...
              className="pl-8 bg-white  rounded-full"
            />
          </div>
        ...
        {paginatedProducts.length === 0 ? (
          <h2 className="text-zinc-500 font-bold text-center text-xl p-16">
            No Products!
          </h2>
        ) : (
              ...
              <Table className="w-full ">
                ...
                <TableBody>
                  {paginatedProducts.map((product, index) => (
                    <TableRow key={product.id} className="border-b h-[60px]">
                      ...
                      <TableCell className=" w-max whitespace-nowrap space-x-4 ">
                        <div className="flex  items-center justify-center">
                          <Button
                            ...
                            variant="ghost"
                            className="hover:bg-gray-100 w-10"
                          >
                            <ChevronRight />
                          </Button>
                        </div>
