      ...
      <main className="container  mx-auto px-4 py-8 max-w-7xl">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <ProductTitleRating title={product.title} description={product.description} rating={product.rating} />
        ...
        {/* RELATED PRODUCTS */}
        <RelatedProducts category={product.category.toString()} currentProductId={product.id} />
      </main>
    </div>
  )
}
