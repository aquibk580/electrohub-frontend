...
export const mockData = {
  ...
  topsellers: Array.from({ length: 10 }, (_, i) => ({
    ...
    sellerNiche: ["Electronics", "Clothing", "Toys", "Books", "Furniture"][i % 5],
    totalProfits: `₹${(Math.random() * 10_000_000).toFixed(2)}`,
    totalItemsSold: `${Math.floor(Math.random() * 500_000)}`,
    originCountry: ["India", "United States", "China", "Germany", "Canada"][i % 5],
  })),
  ...
  orders: Array.from({ length: 50 }, (_, i) => ({
    ...
    productName: `Product ${i + 1} (${["Electronics", "Clothing", "Toys", "Books", "Furniture"][i % 5]})`,
    customer: `CUST${i + 1}`,
    customerName: `Customer ${i + 1}`,
    date: `Jan ${Math.floor(Math.random() * 30) + 1}, ${Math.floor(Math.random() * 24)}:${Math.floor(Math.random() * 60)} PM`,
    ...
    orderDetails: {
      orderTimeline: [
        {
          status: "Order Placed",
          date: `Jan ${Math.floor(Math.random() * 30) + 1}, 2024 ${Math.floor(Math.random() * 12) + 1}:${Math.floor(Math.random() * 60)} PM`,
  ...
  allPayments:Array.from({ length: 50 }, (_, i) =>({
    id: `UP${1000 + i}`,
    pid: `PRD${1000 + i}`,
    paymentMode: ["COD", "Bank Transfer", "Buy Now, Pay Later", "Credit/Debit Cards", "UPI", "Electrohub Wallet", "Digital Wallets"][i % 7],
  ...
  withdrawlRequest: Array.from({ length: 50 }, (_, i) =>({
    id: `RE${1000 + i}`,
    sender: `SELLER${i + 1}`,
    paymentMode: ["COD", "Bank Transfer", "UPI", "Electrohub Wallet", "Digital Wallets"][i % 5],
...
export const tableHeaders = {
  ...
  buyer: [
    ...
    { key: "totalItemsPurchased", label: "Total Items Purchased" },
