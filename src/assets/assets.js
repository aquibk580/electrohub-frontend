...
export const reviews = [
    {
        ...
        author: "Alex M.",
        rating: 5,
        content: "The product exceeded my expectations! The quality is top-notch. Being a designer myself, I'm quite picky about aesthetics, and this definitely meets my standards.",
        verified: true,
    },
    {
        id: 2,
        author: "Samantha D.",
        rating: 4,
        content: "I absolutely love this! The design is unique and feels so comfortable. As a fellow designer, I appreciate the attention to detail. It's become my favorite go-to item.",
        verified: true,
    },
    {
        id: 3,
        author: "John R.",
        rating: 5,
        content: "Fantastic product! It's exactly what I was looking for. The build quality is excellent and it performs brilliantly.",
        verified: true,
    },
    {
        id: 4,
        author: "Emily S.",
        rating: 4,
        content: "Great value for money. It does everything it promises and more. I'm very satisfied with my purchase.",
        verified: true,
    },
    {
        id: 5,
        author: "Michael T.",
        rating: 5,
        content: "I'm impressed with how well-designed this product is. It's intuitive to use and looks great. Highly recommended!",
        verified: true,
    },
    {
        id: 6,
        author: "Sarah L.",
        rating: 4,
        content: "Very good product overall. There are a few minor things that could be improved, but it's still excellent value.",
        verified: true,
    },
];
export const offers = [
...
export const faqs = [
    {
        ...
        answer: "The product comes with 1 year manufacturer warranty and 6 months warranty on accessories.",
    },
    {
        question: "Is this product eligible for return?",
        answer: "Yes, this product is eligible for return within 7 days of delivery if unused and in original packaging.",
    },
    {
        question: "Do you provide installation service?",
        answer: "Yes, we provide free installation service for this product in selected cities.",
    },
];
